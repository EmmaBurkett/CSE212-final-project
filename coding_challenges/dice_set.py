...
class DiceGame:
    ...
    def check_uniqueness(self):
        ...
        ##############################################################
        # Coding challenge:
        # Change this method to reward points to the user once for
        # every pair of duplicate dice.
        # Ex. A roll of 6, 5, 4, 4, 4, 4
        # Total score = (highest die) + (Number of pairs)
        # Total score = 6 + 2 = 8
        # Ex. A roll of 6, 5, 4, 4, 4, 3
        # Total score = 6 + 1 = 7
        #
        # You cannot use a counter to solve this challenge.
        ##############################################################
