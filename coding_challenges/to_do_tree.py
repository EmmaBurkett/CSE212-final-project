class ToDoList:
    ...
    def find_task(self, node, duration):
        ...
        ###############################################################
        # Coding challenge:
        # Create a method that prints the largest possible task that
        # can get done inside the given duration. 
        # Note:
        # When the passed in duration is not in the tree it should print
        # the largest task that can get done in the given time period. 
        ###############################################################
